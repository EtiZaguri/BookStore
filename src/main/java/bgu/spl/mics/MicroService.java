...
public abstract class MicroService implements Runnable {
    ...
    private ConcurrentHashMap<Class<?>, Callback<?>> hashMapCallBacks;
    ...
    public MicroService(String name) {
        this.name = name;
        this.hashMapCallBacks= new ConcurrentHashMap<>();
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) {
        ...
        hashMapCallBacks.putIfAbsent(type,callback);
    ...
    public final void run() {
        ...
        while (!terminated) {
            try {
                ...
                Callback callback=hashMapCallBacks.get(message.getClass());
